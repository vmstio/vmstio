...
We previously listed all defederated instances on at [vmst.io/about](https://vmst.io/about), but have since switched to posting the listing in CSV format on our GitHub.
...
The rationale for this change was to limit the listing of domains that sometimes contained offensive language or hosted illegal material.
Being posted in CSV also allows other instance administrators to easily import our blocklist or compare it against their own.
