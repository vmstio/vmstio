...
We use an all virtual architecture using Digital Ocean "Droplets" with [Rocky Linux](https://www.rockylinux.org) as the base operating system for our self-managed systems.
