...
#default
    ...
    ::card{icon="ph:device-mobile-speaker-bold"}
    #title
    iOS
    #description
    ...
    Web
    #description
    [Official Client](https://vmst.io), [Elephant](/flings/elephant), [Tangerine](/flings/tangerine), [Elk](https://elk.vmst.io/), [Semaphore](https://semaphore.vmst.io), [Phanpy](https://phanpy.vmst.io), 
    ::
